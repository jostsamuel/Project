...
namespace Managment_System
{
    public partial class SellerForm : Form
    {
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            try
            {
                string insertQuery = "INSERT INTO Seller VALUES(" + TextBox_id.Text + ",'" + TextBox_name.Text + "','" + TextBox_age.Text + "','" + TextBox_phone.Text + "','" + "')";
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string updateQuery = "UPDATE Seller SET SellerName='" + TextBox_name.Text + "',SellerAge='" + TextBox_age.Text + "',SellerPhone='" + TextBox_phone.Text + "',SellerPass='" + "'WHERE SellerId=" + TextBox_id.Text + "";
